...
<body>
 ...
 %>
					...
					<td><input type="text" name="subject"
						style="<%=subjectErr != null ? "background-color:#ffcccc;" : ""%>"
						value="<%=subjectVal%>"></td>
				</tr>
				<tr>
					<th>お問い合わせ内容：<%
 ...
 %>
					...
					<td><textarea name="comments" rows="16" cols="45"
							style="<%=commentsErr != null ? "background-color:#ffcccc;" : ""%>"><%=commentsVal%></textarea></td>
				</tr>
			</table>
